.. _pygeonlp_webapi_option_time_exists:

time-exists オプション
======================

``TimeExistsFilter`` を作成し、 :ref:`pygeonlp_webapi_parse`
...
.. literalinclude:: ../json/test_time_exists_req.json
   :language: javascript
...
.. literalinclude:: ../json/test_time_exists_res.json
  :language: javascript

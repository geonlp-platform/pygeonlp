.. _pygeonlp_webapi_option_add_class:
...
``set-class``, ``remove-class`` が指定されていない場合は
``[r'.*']`` に対して追加します。
...
.. literalinclude:: ../json/test_parse_add_class_req.json
   :language: javascript
...
.. literalinclude:: ../json/test_parse_add_class_res.json
  :language: javascript
